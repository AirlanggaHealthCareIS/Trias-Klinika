 ...
 * @author Faz
 */
public class Scenario_4_Login_Tidak_Sukses_Username_dan_Password_Kosong {
    private String ip;
    private Registry registry;
    private LoginService service1;
    private LoginEntitas users = new LoginEntitas();
    
    public Scenario_4_Login_Tidak_Sukses_Username_dan_Password_Kosong() throws RemoteException, NotBoundException {
    }
    ...
    public void testCek() {
        ...
        String expResult = "Masukkan Username dan Password Terlebih Dahulu";
