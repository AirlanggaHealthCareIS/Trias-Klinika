 ...
 * @author Faz
 */
public class Scenario_6_Login_Tidak_Sukses_Password_Kosong {
    private String ip;
    private Registry registry;
    private LoginService service1;
    private LoginEntitas users = new LoginEntitas();
    
    public Scenario_6_Login_Tidak_Sukses_Password_Kosong() throws RemoteException, NotBoundException {
    }
    ...
    public void testCek() {
        ...
        String expResult = "Masukkan Password Terlebih Dahulu";
