 ...
 * @author Azmil
 */
public class scenario_2_pengecekan_stok_masa_expired {
    private String ip;
    ...
    public scenario_2_pengecekan_stok_masa_expired() throws RemoteException, NotBoundException{
    }
